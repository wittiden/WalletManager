...
class PasswordValueNotExistsError(Exception):
    pass
...
class UserIsNotClientError(Exception):
    pass
...
class WalletIsBlockedError(Exception):
    pass


class WalletIsNotBlockedError(Exception):
    pass
