...
class TransactionTable(Base):
    ...
    from_currency: Mapped['WalletBalanceCurrenciesEnum'] = mapped_column(Enum(WalletBalanceCurrenciesEnum, name='wallet_balance_currency_enum'), nullable=True)
    to_currency: Mapped['WalletBalanceCurrenciesEnum'] = mapped_column(Enum(WalletBalanceCurrenciesEnum, name='wallet_balance_currency_enum'), nullable=True)
