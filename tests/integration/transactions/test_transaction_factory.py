...
class TestTransactionFactory:
    ...
    def test_create_deposit_transaction(self, container, sample_transaction_deposit):
        ...
        transaction = transaction_factory.create_transaction(sample_transaction_deposit.operation_type, sample_transaction_deposit.from_address, sample_transaction_deposit.to_address, sample_transaction_deposit.completed_at, sample_transaction_deposit.amount, sample_transaction_deposit.fee, sample_transaction_deposit.deposit_currency)
        ...
        assert transaction.deposit_currency == sample_transaction_deposit.deposit_currency
