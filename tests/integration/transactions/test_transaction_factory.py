...
class TestTransactionFactory:
    ...
    def test_create_deposit_transaction_good(self, container, sample_transaction_deposit):
        ...
        transaction = transaction_factory.create_transaction(
            sample_transaction_deposit.operation_type,
            sample_transaction_deposit.from_address,
            sample_transaction_deposit.to_address,
            sample_transaction_deposit.completed_at,
            sample_transaction_deposit.amount,
            sample_transaction_deposit.fee,
            sample_transaction_deposit.currency,
        )
    ...
    def test_create_withdraw_transaction_good(self, container, sample_transaction_withdraw):
        ...
        transaction = transaction_factory.create_transaction(
            sample_transaction_withdraw.operation_type,
            sample_transaction_withdraw.from_address,
            sample_transaction_withdraw.to_address,
            sample_transaction_withdraw.completed_at,
            sample_transaction_withdraw.amount,
            sample_transaction_withdraw.fee,
            sample_transaction_withdraw.currency,
        )
    ...
    def test_create_exchange_transaction_good(self, container, sample_transaction_exchange):
        ...
        transaction = transaction_factory.create_transaction(
            sample_transaction_exchange.operation_type,
            sample_transaction_exchange.from_address,
            sample_transaction_exchange.to_address,
            sample_transaction_exchange.completed_at,
            sample_transaction_exchange.amount,
            sample_transaction_exchange.fee,
            sample_transaction_exchange.from_currency,
            sample_transaction_exchange.to_currency,
            sample_transaction_exchange.rate,
        )
